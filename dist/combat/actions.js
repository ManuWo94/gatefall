 ...
 */
import { ActionTag, TelegraphType, ThreatLevel, StatusEffectType, CombatRole } from './combat-types.js';
// ==================== SPIELER-AKTIONEN ====================
export const PLAYER_BASIC_ACTIONS = [
    {
        id: 'basic_attack',
...
export const PLAYER_ADVANCED_ACTIONS = [
    {
        id: 'heavy_strike',
...
// ==================== GEGNER-AKTIONEN ====================
export const ENEMY_BASIC_ACTIONS = [
    {
        id: 'enemy_slash',
        name: 'Klauenangriff',
        tags: [ActionTag.SCHLAG],
...
export const ENEMY_ADVANCED_ACTIONS = [
    {
        id: 'devastating_blow',
