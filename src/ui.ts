...
export class UIRenderer {
    ...
    private static readonly ROLE_SKILL_NAMES: Record<Role, Record<number, string>> = {
        ...
        [Role.BESCHWOERER]: { 1: 'Beschwörung', 2: 'Elementargeist', 3: 'Verstärken' },
        [Role.BERSERKER]: { 1: 'Wutschlag', 2: 'Raserei', 3: 'Blutdurst' },
        [Role.FLUCHWIRKER]: { 1: 'Verfluchung', 2: 'Furcht', 3: 'Gift' },
        [Role.HUNTER]: { 1: 'Hunter-Schlag', 2: 'Erwachte Kraft', 3: 'Doppelschlag' }
    };
